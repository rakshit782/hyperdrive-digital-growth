...
const AuthorizedPartners = () => {
  ...
  return (
    <section className="py-4 bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 border-b border-slate-700/50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-3">
          <h3 className="text-xs font-semibold text-slate-300 uppercase tracking-wide mb-1">Authorized Partners</h3>
