        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left">
              ...
              <div className="space-y-6">
                <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 leading-tight">
                  <span className="block mb-2">Get 3x</span>
                  <span className="bg-gradient-to-r from-indigo-600 via-blue-600 to-violet-600 bg-clip-text text-transparent block mb-2">
                    Higher ROAS
                  </span>
              ...
              <div className="grid grid-cols-3 gap-4 bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/50 shadow-lg">
                <div className="text-center">
                  <div className="text-xl lg:text-2xl font-bold text-indigo-600 mb-1">300%</div>
                  <div className="text-sm text-slate-600 font-medium">Avg ROAS Increase</div>
                </div>
                <div className="text-center border-x border-slate-200">
                  <div className="text-xl lg:text-2xl font-bold text-emerald-600 mb-1">24hrs</div>
                  <div className="text-sm text-slate-600 font-medium">Setup Time</div>
                </div>
                <div className="text-center">
                  <div className="text-xl lg:text-2xl font-bold text-violet-600 mb-1">98%</div>
            ...
            <div className="relative mt-8 lg:mt-0">
                ...
                <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-2xl p-6 border border-indigo-100">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-emerald-600 font-bold">+300% ROAS</span>
                    </div>
                  </div>
                  
                  {/* Mock chart */}
                  <div className="h-32 bg-gradient-to-r from-indigo-400 via-blue-500 to-violet-400 rounded-xl opacity-90 flex items-center justify-center relative overflow-hidden mb-4">
                    <div className="absolute inset-0 bg-white/10 backdrop-blur-sm"></div>
                    <div className="relative z-10 text-center">
                      <div className="text-white font-bold text-2xl mb-2">$847K</div>
                      <div className="text-indigo-100 text-sm">Revenue Generated This Month</div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white/80 rounded-lg p-4">
                      <div className="text-lg font-bold text-indigo-600 mb-1">$2.8M</div>
                      <div className="text-sm text-slate-600">Total Ad Spend Managed</div>
                    </div>
                    <div className="bg-white/80 rounded-lg p-4">
                      <div className="text-lg font-bold text-emerald-600 mb-1">127</div>
              ...
              <div className="absolute -top-4 -right-4 bg-gradient-to-r from-amber-400 to-orange-400 text-white rounded-full p-3 shadow-xl animate-bounce">
                <Star className="w-6 h-6 fill-white" />
              </div>
              <div className="absolute -bottom-4 -left-4 bg-gradient-to-r from-indigo-500 to-blue-500 text-white rounded-full p-3 shadow-xl">
                <TrendingUp className="w-6 h-6" />
              </div>
              
              {/* Achievement badge */}
              <div className="absolute top-4 -left-6 bg-white rounded-full p-3 shadow-lg border-2 border-emerald-200">
                <div className="text-center">
