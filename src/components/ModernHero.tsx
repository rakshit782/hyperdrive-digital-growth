        ...
        <div className="text-center space-y-8">
          ...
          <div className="space-y-6 max-w-5xl mx-auto">
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-white leading-tight tracking-tight">
              <span className="block">{settings.headline.main}</span>
              <span className="bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent block">
          ...
          {settings.stats.enabled && (
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 bg-white/10 backdrop-blur-md rounded-3xl p-8 lg:p-10 border border-white/20 shadow-xl max-w-4xl mx-auto">
          ...
          {settings.urgency.enabled && (
            <div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 border border-orange-400/30 rounded-2xl p-5 inline-block backdrop-blur-md">
