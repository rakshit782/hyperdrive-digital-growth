  ...
  'shopify-integration': [
    {
      ...
      stat_value: '450%',
      stat_description: 'Average multi-channel sales growth',
      icon_name: 'TrendingUp',
      is_active: true,
      sort_order: 1,
      created_at: '2024-01-01T00:00:00Z',
    ...
    },
    {
      id: '22',
      service_type: 'shopify-integration',
      stat_label: 'Inventory Accuracy',
      stat_value: '99.7%',
      stat_description: 'Real-time sync across all marketplaces',
      icon_name: 'Database',
      is_active: true,
      sort_order: 2,
      created_at: '2024-01-01T00:00:00Z',
    ...
    },
    {
      id: '23',
      service_type: 'shopify-integration',
      stat_label: 'Sync Speed',
      stat_value: '5 min',
      stat_description: 'Real-time inventory synchronization',
      icon_name: 'RefreshCw',
      is_active: true,
      sort_order: 3,
      created_at: '2024-01-01T00:00:00Z',
    ...
    },
    {
      id: '24',
      service_type: 'shopify-integration',
      stat_label: 'Overselling Prevention',
      stat_value: '92%',
      stat_description: 'Reduction in overselling and stockouts',
