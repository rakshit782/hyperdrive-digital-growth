...
const WalmartAdvertising = () => {
  const { caseStudies, stats, reviews } = useServiceData('walmart');
  ...
  return (
    <>
      ...
      <section className="py-24 md:py-32 bg-gradient-to-br from-slate-50 via-green-50 to-blue-50 relative overflow-hidden">
